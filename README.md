...
```
cargo run -- --http <http RPC url> --mevblocker-http <mevblocker http url> --private-key <private key> --bid-percentage <percent of profit to share as gas> --order-type <Priority|DutchV2|DutchV3|Hybrid> --chain-id <chain id> --executor-address <executor address>
```
...
```
forge bind --root ../UniswapX  --overwrite --alloy --alloy-version 1.4.2 # replace UniswapX with the path to the UniswapX repo
```
