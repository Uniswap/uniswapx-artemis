...
```*/
    ...
    const _: () = {
        ...
        impl unwrapWETH9Return {
            fn _tokenize(
                &self,
            ) -> <unwrapWETH9Call as alloy_sol_types::SolCall>::ReturnToken<'_> {
                ()
            }
        }
        #[automatically_derived]
        impl alloy_sol_types::SolCall for unwrapWETH9Call {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                unwrapWETH9Return::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
            ...
            static DECODE_VALIDATE_SHIMS: &[fn(
                ...
                },
                {
                    fn unwrapWETH9(
                        ...
                        <unwrapWETH9Call as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(ISwapRouter02Calls::unwrapWETH9)
                    }
                ...
                },
                {
                    fn exactInput(
                        ...
                        <exactInputCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(ISwapRouter02Calls::exactInput)
                    }
...
See the [wrapper's documentation](`ISwapRouter02Instance`) for more details.*/
    ...
    >(
        ...
        ISwapRouter02Instance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        ISwapRouter02Instance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        ISwapRouter02Instance::<P, N>::deploy_builder(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    > ISwapRouter02Instance<P, N> {
        ...
        ) -> alloy_contract::SolCallBuilder<&P, exactInputCall, N> {
        ...
        ) -> alloy_contract::SolCallBuilder<&P, unwrapWETH9Call, N> {
