...
interface IAuctionResolver {
    ...
    function resolve(SignedOrder memory signedOrder) external view returns (ResolvedOrder memory resolvedOrder);
}
```
...
```*/
    ...
    ///Container for all the [`IAuctionResolver`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum IAuctionResolverCalls {
        #[allow(missing_docs)]
        getPermit2OrderType(getPermit2OrderTypeCall),
        #[allow(missing_docs)]
        resolve(resolveCall),
    }
    impl IAuctionResolverCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IAuctionResolverCalls {
        const NAME: &'static str = "IAuctionResolverCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<IAuctionResolverCalls>] = &[
                {
                    fn resolve(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<IAuctionResolverCalls> {
                        <resolveCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IAuctionResolverCalls::resolve)
                    }
                    resolve
                },
                {
                    fn getPermit2OrderType(
                        ...
                        <getPermit2OrderTypeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IAuctionResolverCalls::getPermit2OrderType)
                    }
                    getPermit2OrderType
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`IAuctionResolver`](self) contract instance.

See the [wrapper's documentation](`IAuctionResolverInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        __provider: P,
    ) -> IAuctionResolverInstance<P, N> {
        IAuctionResolverInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IAuctionResolverInstance<P, N>>,
    > {
        IAuctionResolverInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IAuctionResolverInstance::<P, N>::deploy_builder(__provider)
    }
    /**A [`IAuctionResolver`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IAuctionResolver`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IAuctionResolverInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IAuctionResolverInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IAuctionResolverInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<IAuctionResolverInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> IAuctionResolverInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IAuctionResolverInstance<P, N> {
            IAuctionResolverInstance {
