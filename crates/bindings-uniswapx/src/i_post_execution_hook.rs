...
```*/
    ...
    ///Container for all the [`IPostExecutionHook`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum IPostExecutionHookCalls {
        #[allow(missing_docs)]
        postExecutionHook(postExecutionHookCall),
    }
    impl IPostExecutionHookCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[167u8, 122u8, 107u8, 10u8]];
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IPostExecutionHookCalls {
        const NAME: &'static str = "IPostExecutionHookCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<IPostExecutionHookCalls>] = &[
                {
                    fn postExecutionHook(
                        ...
                        <postExecutionHookCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IPostExecutionHookCalls::postExecutionHook)
                    }
                    postExecutionHook
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`IPostExecutionHook`](self) contract instance.

See the [wrapper's documentation](`IPostExecutionHookInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        __provider: P,
    ) -> IPostExecutionHookInstance<P, N> {
        IPostExecutionHookInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IPostExecutionHookInstance<P, N>>,
    > {
        IPostExecutionHookInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IPostExecutionHookInstance::<P, N>::deploy_builder(__provider)
    }
    /**A [`IPostExecutionHook`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IPostExecutionHook`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IPostExecutionHookInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IPostExecutionHookInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IPostExecutionHookInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<IPostExecutionHookInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> IPostExecutionHookInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IPostExecutionHookInstance<P, N> {
            IPostExecutionHookInstance {
