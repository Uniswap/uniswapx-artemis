...
pub mod MockArbSys {
    ...
    ///
    /// ```text
    
    /// ```
    #[rustfmt::skip]
    #[allow(clippy::all)]
    pub static BYTECODE: alloy_sol_types::private::Bytes = alloy_sol_types::private::Bytes::from_static(
        b"`\x80`@R4\x80\x15`\x0EW__\xFD[P`\xA5\x80`\x1A_9_\xF3\xFE`\x80`@R4\x80\x15`\x0EW__\xFD[P`\x046\x10`0W_5`\xE0\x1C\x80c\xA3\xB1\xB3\x1D\x14`4W\x80c\xA8\xC3\xC8P\x14`HW[__\xFD[_T`@Q\x90\x81R` \x01`@Q\x80\x91\x03\x90\xF3[`W`S6`\x04`YV[_UV[\0[_` \x82\x84\x03\x12\x15`hW__\xFD[P5\x91\x90PV\xFE\xA2dipfsX\"\x12 \xAD[,\x01\xAE\xD3\x01\xBE*O\xFB\xB7,,\"\xF1\xBB\x13\xCEK`\x99Fn0U\xA3\xA2Jc\xAD\xB6dsolcC\0\x08\x1E\x003",
    );
    /// The runtime bytecode of the contract, as deployed on the network.
    ///
    /// ```text
    
    /// ```
    #[rustfmt::skip]
    #[allow(clippy::all)]
    pub static DEPLOYED_BYTECODE: alloy_sol_types::private::Bytes = alloy_sol_types::private::Bytes::from_static(
        b"`\x80`@R4\x80\x15`\x0EW__\xFD[P`\x046\x10`0W_5`\xE0\x1C\x80c\xA3\xB1\xB3\x1D\x14`4W\x80c\xA8\xC3\xC8P\x14`HW[__\xFD[_T`@Q\x90\x81R` \x01`@Q\x80\x91\x03\x90\xF3[`W`S6`\x04`YV[_UV[\0[_` \x82\x84\x03\x12\x15`hW__\xFD[P5\x91\x90PV\xFE\xA2dipfsX\"\x12 \xAD[,\x01\xAE\xD3\x01\xBE*O\xFB\xB7,,\"\xF1\xBB\x13\xCEK`\x99Fn0U\xA3\xA2Jc\xAD\xB6dsolcC\0\x08\x1E\x003",
    );
...
```*/
    ...
    const _: () = {
        ...
        impl setBlockNumberReturn {
            fn _tokenize(
                &self,
            ) -> <setBlockNumberCall as alloy_sol_types::SolCall>::ReturnToken<'_> {
                ()
            }
        }
        #[automatically_derived]
        impl alloy_sol_types::SolCall for setBlockNumberCall {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                setBlockNumberReturn::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
...
See the [wrapper's documentation](`MockArbSysInstance`) for more details.*/
    ...
    >(
        ...
        __provider: P,
    ) -> MockArbSysInstance<P, N> {
        MockArbSysInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<MockArbSysInstance<P, N>>,
    > {
        MockArbSysInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        MockArbSysInstance::<P, N>::deploy_builder(__provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct MockArbSysInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for MockArbSysInstance<P, N> {
        #[inline]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<MockArbSysInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> MockArbSysInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> MockArbSysInstance<P, N> {
            MockArbSysInstance {
