...
```*/
    ...
    ///Container for all the [`IPreExecutionHook`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum IPreExecutionHookCalls {
        #[allow(missing_docs)]
        preExecutionHook(preExecutionHookCall),
    }
    impl IPreExecutionHookCalls {
        ...
        pub const SELECTORS: &'static [[u8; 4usize]] = &[[216u8, 182u8, 29u8, 237u8]];
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IPreExecutionHookCalls {
        const NAME: &'static str = "IPreExecutionHookCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<IPreExecutionHookCalls>] = &[
                {
                    fn preExecutionHook(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<IPreExecutionHookCalls> {
                        <preExecutionHookCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IPreExecutionHookCalls::preExecutionHook)
                    }
                    preExecutionHook
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`IPreExecutionHook`](self) contract instance.

See the [wrapper's documentation](`IPreExecutionHookInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        __provider: P,
    ) -> IPreExecutionHookInstance<P, N> {
        IPreExecutionHookInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IPreExecutionHookInstance<P, N>>,
    > {
        IPreExecutionHookInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IPreExecutionHookInstance::<P, N>::deploy_builder(__provider)
    }
    /**A [`IPreExecutionHook`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IPreExecutionHook`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IPreExecutionHookInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IPreExecutionHookInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IPreExecutionHookInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<IPreExecutionHookInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> IPreExecutionHookInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IPreExecutionHookInstance<P, N> {
            IPreExecutionHookInstance {
