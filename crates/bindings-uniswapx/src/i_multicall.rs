...
```*/
    ...
    ///Container for all the [`IMulticall`](self) function calls.
    #[derive(Clone)]
    #[derive(serde::Serialize, serde::Deserialize)]
    #[derive()]
    pub enum IMulticallCalls {
        #[allow(missing_docs)]
        multicall(multicallCall),
    }
    impl IMulticallCalls {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IMulticallCalls {
        const NAME: &'static str = "IMulticallCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
            ) -> alloy_sol_types::Result<IMulticallCalls>] = &[
                {
                    fn multicall(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<IMulticallCalls> {
                        <multicallCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IMulticallCalls::multicall)
                    }
                    multicall
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`IMulticall`](self) contract instance.

See the [wrapper's documentation](`IMulticallInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        __provider: P,
    ) -> IMulticallInstance<P, N> {
        IMulticallInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IMulticallInstance<P, N>>,
    > {
        IMulticallInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IMulticallInstance::<P, N>::deploy_builder(__provider)
    }
    /**A [`IMulticall`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IMulticall`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IMulticallInstance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IMulticallInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IMulticallInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<IMulticallInstance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> IMulticallInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IMulticallInstance<P, N> {
            IMulticallInstance {
