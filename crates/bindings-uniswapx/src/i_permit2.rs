...
```*/
    ...
    const _: () = {
        ...
        impl permit_0Return {
            fn _tokenize(
                &self,
            ) -> <permit_0Call as alloy_sol_types::SolCall>::ReturnToken<'_> {
                ()
            }
        }
        #[automatically_derived]
...
```*/
    ...
    const _: () = {
        ...
        impl permit_1Return {
            fn _tokenize(
                &self,
            ) -> <permit_1Call as alloy_sol_types::SolCall>::ReturnToken<'_> {
                ()
            }
        }
        #[automatically_derived]
...
```*/
    ...
    const _: () = {
        ...
        impl transferFrom_0Return {
            fn _tokenize(
                &self,
            ) -> <transferFrom_0Call as alloy_sol_types::SolCall>::ReturnToken<'_> {
                ()
            }
        }
        #[automatically_derived]
        impl alloy_sol_types::SolCall for transferFrom_0Call {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                transferFrom_0Return::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
...
```*/
    ...
    const _: () = {
        ...
        impl transferFrom_1Return {
            fn _tokenize(
                &self,
            ) -> <transferFrom_1Call as alloy_sol_types::SolCall>::ReturnToken<'_> {
                ()
            }
        }
        #[automatically_derived]
        impl alloy_sol_types::SolCall for transferFrom_1Call {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                transferFrom_1Return::_tokenize(ret)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<
    ...
    impl IPermit2Calls {
        ...
        pub const SIGNATURES: &'static [&'static str] = &[
            <transferFrom_0Call as alloy_sol_types::SolCall>::SIGNATURE,
            <permitWitnessTransferFrom_0Call as alloy_sol_types::SolCall>::SIGNATURE,
            <permit_0Call as alloy_sol_types::SolCall>::SIGNATURE,
            <permit_1Call as alloy_sol_types::SolCall>::SIGNATURE,
            <permitTransferFrom_0Call as alloy_sol_types::SolCall>::SIGNATURE,
            <DOMAIN_SEPARATORCall as alloy_sol_types::SolCall>::SIGNATURE,
            <transferFrom_1Call as alloy_sol_types::SolCall>::SIGNATURE,
    ...
    impl alloy_sol_types::SolInterface for IPermit2Calls {
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                ...
                {
                    fn permit_0(data: &[u8]) -> alloy_sol_types::Result<IPermit2Calls> {
                        <permit_0Call as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(IPermit2Calls::permit_0)
                    }
                    permit_0
                },
                {
                    fn permit_1(data: &[u8]) -> alloy_sol_types::Result<IPermit2Calls> {
                        <permit_1Call as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                {
                    fn approve(data: &[u8]) -> alloy_sol_types::Result<IPermit2Calls> {
                ...
                {
                    fn allowance(data: &[u8]) -> alloy_sol_types::Result<IPermit2Calls> {
                ...
                {
                    fn lockdown(data: &[u8]) -> alloy_sol_types::Result<IPermit2Calls> {
            ...
            static DECODE_VALIDATE_SHIMS: &[fn(
            ...
            ) -> alloy_sol_types::Result<IPermit2Calls>] = &[
                {
                    fn transferFrom_0(
                        ...
                        <transferFrom_0Call as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IPermit2Calls::transferFrom_0)
                    }
                ...
                {
                    fn permit_0(data: &[u8]) -> alloy_sol_types::Result<IPermit2Calls> {
                        <permit_0Call as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IPermit2Calls::permit_0)
                    }
                ...
                {
                    fn permit_1(data: &[u8]) -> alloy_sol_types::Result<IPermit2Calls> {
                        <permit_1Call as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IPermit2Calls::permit_1)
                    }
                ...
                },
                {
                    fn transferFrom_1(
                        ...
                        <transferFrom_1Call as alloy_sol_types::SolCall>::abi_decode_raw_validate(
                                data,
                            )
                            .map(IPermit2Calls::transferFrom_1)
                    }
...
See the [wrapper's documentation](`IPermit2Instance`) for more details.*/
    ...
    >(
        address: alloy_sol_types::private::Address,
        __provider: P,
    ) -> IPermit2Instance<P, N> {
        IPermit2Instance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IPermit2Instance<P, N>>,
    > {
        IPermit2Instance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        IPermit2Instance::<P, N>::deploy_builder(__provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IPermit2Instance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network: ::core::marker::PhantomData<N>,
    }
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for IPermit2Instance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            __provider: P,
        ) -> alloy_contract::Result<IPermit2Instance<P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<P: ::core::clone::Clone, N> IPermit2Instance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IPermit2Instance<P, N> {
            IPermit2Instance {
                address: self.address,
                provider: ::core::clone::Clone::clone(&self.provider),
                _network: ::core::marker::PhantomData,
    ...
    > IPermit2Instance<P, N> {
        ...
        ) -> alloy_contract::SolCallBuilder<&P, permit_0Call, N> {
            self.call_builder(
                &permit_0Call {
                    owner,
                    permitBatch,
        ...
        pub fn permit_1(
            ...
            signature: alloy::sol_types::private::Bytes,
        ) -> alloy_contract::SolCallBuilder<&P, permit_1Call, N> {
            self.call_builder(
                &permit_1Call {
                    owner,
                    permitSingle,
        ...
        pub fn transferFrom_0(
            ...
            transferDetails: alloy::sol_types::private::Vec<
                <IAllowanceTransfer::AllowanceTransferDetails as alloy::sol_types::SolType>::RustType,
            >,
        ) -> alloy_contract::SolCallBuilder<&P, transferFrom_0Call, N> {
            self.call_builder(
                &transferFrom_0Call {
                    transferDetails,
                },
        ...
        pub fn transferFrom_1(
            ...
            amount: alloy::sol_types::private::primitives::aliases::U160,
            token: alloy::sol_types::private::Address,
        ) -> alloy_contract::SolCallBuilder<&P, transferFrom_1Call, N> {
            self.call_builder(
                &transferFrom_1Call {
                    from,
                    to,
